...
func (cfg *Configuration) execHook(rl *release.Release, hook release.HookEvent, timeout time.Duration, disableVerify bool) error {
	...
	for _, h := range executingHooks {
		...
		resources, err := cfg.KubeClient.Build(bytes.NewBufferString(h.Manifest), !disableVerify)
		if err != nil {
